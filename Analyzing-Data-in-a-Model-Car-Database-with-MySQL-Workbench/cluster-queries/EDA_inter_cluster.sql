----------------------------------------------------------------------- Inter-Cluster Exploratory Data Analysis ---------------------------------------------------------------------------------------
----------------------------------------------- This script explores relationships across all 3 clusters: Products, Customers, and Employees ----------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
JOIN products_cluster_view p ON c.orderNumber = p.orderNumber
...
SELECT 
    ...
    c.totalPayments
 FROM orders o
 JOIN customers_cluster_view c ON o.customerNumber = c.customerNumber
