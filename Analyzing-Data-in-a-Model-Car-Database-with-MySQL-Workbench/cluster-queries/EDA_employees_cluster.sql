...
SELECT COUNT(employeeNumber) AS totalEmployees FROM employees_cluster_view; -- Mint Classics employs a total of 108 employees
...
FROM 
    employees_cluster_view e
JOIN 
    employees_cluster_view m ON e.reportsTo = m.employeeNumber
GROUP BY 
