-------------------------------------------------------------------- Exploratory Data Analysis for Products Cluster ---------------------------------------------------------------------------------
----------- The Products Cluster View displays data for all products carried by the Mint Classics Company joining rows across the Products, Orders Details, Orders, and Warehouses tables -----------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
SELECT * FROM products_cluster_view WHERE warehouseCode IS NULL; -- Empty Set: All products sold by Mint Classics are currently being stored in MintClassics warehouses
...
SELECT * FROM products_cluster_view WHERE orderNumber IS NULL; -- The 1985 Toyota Supra (productCode# S18_3233) currently has no sales, 7733 items in stock , and is stored in warehouse 'b'
